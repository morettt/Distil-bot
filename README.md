...
PS：为了证明我没有收他们家的广告费，我吐槽几句。为啥必须得50起充啊？没有自定义金额啊？还有怎么有些模型的API处理速度那么慢啊？编辑界面模型复制都复制不了，还得让我手打，眼睛都要看花了，交互做的什么啊？懂不懂用户心理？最近流输出有BUG，我提交问题给客服，说没有出问题。然后我就用他们官网的示例代码运行演示，然后报错了。然后客服就不理我了。呵呵。
